          ...
          <div className="card-body">
            <div className="stats stats-vertical lg:stats-horizontal">
              <div className="stat">
                ...
                <div className="stat-valu text-primary">{problems.length}</div>
              </div>

              <div className="stat">
                <div className="stat-title">Easy</div>
                <div className="stat-valu text-success">
                  {easyProblemsCount}
                </div>
              </div>
              ...
              <div className="stat">
                ...
                <div className="stat-valu text-warning">
                  {mediumProblemsCount}
                </div>
              </div>
              ...
              <div className="stat">
                ...
                <div className="stat-valu text-error">
                  {hardProblemsCount}
                </div>
              </div>
            </div>
